...
<body data-tab="timeline">
  ...
  <script>
    ...
    const mMap = L.map('m-map', {{
      ...
      // 使用高德官方无线 CDN 瓦片引擎 (wprd01-04)，国内秒开，无 GFW 阻断
      const gaodeUrl = 'https://wprd0{{s}}.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=' + primaryStyle + '&x={{x}}&y={{y}}&z={{z}}';
      const layer = L.tileLayer(gaodeUrl, {{
        subdomains: '1234',
        minZoom: 3,
        maxZoom: 18,
